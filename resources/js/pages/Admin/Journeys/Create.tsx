...
import { ArrowLeft, Save, Briefcase, Calendar, Image, Settings, Plus, X, Link as LinkIcon, Upload, Building2, GraduationCap, Award, Map, Tag } from 'lucide-react';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/admin/journeys/create' },
];
...
export default function JourneysCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        subtitle: '',
        organization: '',
        type: 'work' as 'work' | 'education' | 'achievement' | 'other',
        description: '',
        skills: [] as string[],
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Add Journey Item</h1>
                            <p className="text-sm text-muted-foreground">Document a milestone in your journey</p>
                        </div>
                    </div>
                    <div className="flex gap-2">
                        ...
                        <Button onClick={handleSubmit} disabled={processing}>
                            ...
                            {processing ? 'Saving...' : 'Save Journey'}
                        </Button>
                    </div>
                </div>
                        ...
                        <div className="space-y-6 lg:col-span-2">
                            ...
                            <Card>
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription>Add a logo for the organization (company, school, etc.)</CardDescription>
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card>
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription>Add photos from this experience (can be viewed fullscreen on the public page)</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
