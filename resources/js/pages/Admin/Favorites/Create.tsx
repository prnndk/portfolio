...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/admin/favorites/create' },
];
...
export default function FavoritesCreate() {
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Add New Favorite</h1>
                            <p className="text-sm text-muted-foreground">Share your favorite movie, music, or book</p>
                        </div>
                    </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <FileUploader
                                        ...
                                        maxFiles={1}
                                        description="Recommended: 400x600px for best display"
                                    />
                                    {errors.image && (
